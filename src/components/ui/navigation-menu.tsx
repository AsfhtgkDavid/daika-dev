	...
	return (
		<NavigationMenuPrimitive.Link
			...
			className={cn(
				...
				"h-full w-full border-2 border-gray-700",
				"text-gray-100 bg-gray-800 hover:bg-gray-200 hover:text-gray-800",
				"aria-[current=page]:bg-gray-100 aria-[current=page]:text-gray-800 aria-[current=page]:scale-125",
				className,
			)}
			{...props}
		/>
